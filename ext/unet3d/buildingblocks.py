...
from ext.unet3d.se import ChannelSELayer3D, ChannelSpatialSELayer3D, SpatialSELayer3D
...
class Decoder(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, basic_module, conv_kernel_size=3, scale_factor=(2, 2, 2), 
